...
<head runat="server">
    ...
    <style>
        ...
        #inicio {
            min-height: 75vh;
            background: url('https://wp.tyt.com.mx/wp-content/uploads/2016/11/kenworth-gpo-ed-1-1024x597.jpg') center/cover no-repeat;
            position: relative;
        }
        #inicio::before {
            content: '';
...
<form id="form1" runat="server">
    ...
    <section id="contact" class="py-5">
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-lg-6">
                    <div class="card-soft text-start">
                        <h4 class="fw-bold mb-3">Información</h4>
                        <p><i class="fa fa-map-marker-alt text-success me-2"></i> Calle 123, Sogamoso, Boyacá</p>
                        <p><i class="fa fa-phone text-success me-2"></i> +57 300 123 4567</p>
                        <p><i class="fa fa-envelope text-success me-2"></i> contacto@labs-logistica.com</p>
                ...
                <div class="col-lg-6">
                    <div class="card-soft">
                        <h4 class="fw-bold mb-3">Solicita tu servicio</h4>
                        ...
                        <button class="btn btn-success w-100 fw-bold">Enviar solicitud</button>
                    </div>
                </div>
            </div>
        </div>
